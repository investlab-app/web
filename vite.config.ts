...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'InvestLab - Professional Stock Analysis',
        short_name: 'InvestLab',
        description: 'Professional stock analysis and investment tracking platform with offline support',
        theme_color: '#1f2937',
        ...
        shortcuts: [
          ...
          },
          {
            ...
            description: 'Browse available instruments',
            url: '/instruments',
            icons: [{ src: 'logo192.png', sizes: '192x192' }],
          },
        ],

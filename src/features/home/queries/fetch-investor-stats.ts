...
export async function fetchInvestorStats(token: string): Promise<InvestorStats> {
  const response = await fetchWithAuth<InvestorStats>('/api/investors/me/stats/', token);

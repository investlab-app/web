...
export const allowedConnections = {
  [SuperNodeTypes.Connector]: [ [SuperNodeTypes.Connector,
    SuperNodeTypes.Rule], [SuperNodeTypes.Connector,
    SuperNodeTypes.Rule]
    
  ],
  [SuperNodeTypes.Flow]: [ [ SuperNodeTypes.Rule, SuperNodeTypes.Connector],[ SuperNodeTypes.Action, SuperNodeTypes.Flow], [ SuperNodeTypes.Action, SuperNodeTypes.Flow],],
...
export const connectionCounts = {
  [SuperNodeTypes.Connector]: { source: [1, 1], target: [1], validIn: [1], validOut: [1, 1] },
  [SuperNodeTypes.Flow]: {
    source: [1, -1, -1],
    target:[1],
    validIn: [1],
  ...
  [SuperNodeTypes.Rule]: { source: [0], target: [1], validIn: [1], validOut: [0] },
};

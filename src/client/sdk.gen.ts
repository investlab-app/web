...
export const graphLangList = <ThrowOnError extends boolean = false>(options?: Options<GraphLangListData, ThrowOnError>) => {
    return (options?.client ?? client).get<GraphLangListResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangListData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangListResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const graphLangCreate = <ThrowOnError extends boolean = false>(options: Options<GraphLangCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<GraphLangCreateResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangCreateData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangCreateResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const graphLangDestroy = <ThrowOnError extends boolean = false>(options: Options<GraphLangDestroyData, ThrowOnError>) => {
    return (options.client ?? client).delete<GraphLangDestroyResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangDestroyData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangDestroyResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const graphLangRetrieve = <ThrowOnError extends boolean = false>(options: Options<GraphLangRetrieveData, ThrowOnError>) => {
    return (options.client ?? client).get<GraphLangRetrieveResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangRetrieveData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangRetrieveResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const graphLangPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<GraphLangPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? client).patch<GraphLangPartialUpdateResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangPartialUpdateData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangPartialUpdateResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const graphLangUpdate = <ThrowOnError extends boolean = false>(options: Options<GraphLangUpdateData, ThrowOnError>) => {
    return (options.client ?? client).put<GraphLangUpdateResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangUpdateData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangUpdateResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const graphLangResultsList = <ThrowOnError extends boolean = false>(options: Options<GraphLangResultsListData, ThrowOnError>) => {
    return (options.client ?? client).get<GraphLangResultsListResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangResultsListData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangResultsListResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const graphLangRunCreate = <ThrowOnError extends boolean = false>(options: Options<GraphLangRunCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<GraphLangRunCreateResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGraphLangRunCreateData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGraphLangRunCreateResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const investorsDepositHistoryList = <ThrowOnError extends boolean = false>(options?: Options<InvestorsDepositHistoryListData, ThrowOnError>) => {
    return (options?.client ?? client).get<InvestorsDepositHistoryListResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zInvestorsDepositHistoryListData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zInvestorsDepositHistoryListResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const investorsMeWatchedTickersList = <ThrowOnError extends boolean = false>(options?: Options<InvestorsMeWatchedTickersListData, ThrowOnError>) => {
    return (options?.client ?? client).get<InvestorsMeWatchedTickersListResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zInvestorsMeWatchedTickersListData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zInvestorsMeWatchedTickersListResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const investorsMeWatchedTickersPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<InvestorsMeWatchedTickersPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? client).patch<InvestorsMeWatchedTickersPartialUpdateResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zInvestorsMeWatchedTickersPartialUpdateData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zInvestorsMeWatchedTickersPartialUpdateResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const ordersLimitList = <ThrowOnError extends boolean = false>(options?: Options<OrdersLimitListData, ThrowOnError>) => {
    return (options?.client ?? client).get<OrdersLimitListResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zOrdersLimitListData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zOrdersLimitListResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const ordersLimitCreate = <ThrowOnError extends boolean = false>(options: Options<OrdersLimitCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<OrdersLimitCreateResponses, OrdersLimitCreateErrors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zOrdersLimitCreateData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zOrdersLimitCreateResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const ordersMarketList = <ThrowOnError extends boolean = false>(options?: Options<OrdersMarketListData, ThrowOnError>) => {
    return (options?.client ?? client).get<OrdersMarketListResponses, unknown, ThrowOnError>({
        requestValidator: async (data) => {
            return await zOrdersMarketListData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zOrdersMarketListResponse.parseAsync(data);
        },
        security: [
            {
                scheme: 'bearer',
...
export const ordersMarketCreate = <ThrowOnError extends boolean = false>(options: Options<OrdersMarketCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<OrdersMarketCreateResponses, OrdersMarketCreateErrors, ThrowOnError>({
        requestValidator: async (data) => {
